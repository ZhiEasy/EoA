...
type BaseInfo struct {
	CpuCores int32 `json:"cpu_cores"`  // 核心数 个
	CpuCacheSize int32 `json:"cpu_cache_size"`  // 缓存大小 MB
	CpuMhz float64 `json:"cpu_mhz"`  // 2200Mhz
	CpuModelName string `json:"cpu_model_name"`  // 型号
	DiskTotal uint64 `json:"disk_total"`  // 磁盘大小 GB
	MemTotal uint64 `json:"mem_total"`  // 内存大小 GB
